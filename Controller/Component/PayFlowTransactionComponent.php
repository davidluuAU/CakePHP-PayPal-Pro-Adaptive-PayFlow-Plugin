...
class PayFlowTransactionComponent extends Component {
	...
	public function execute() {
		...
		$PayPalConfig = array(
								...
								'APIUsername' => $this->payflow_username, 
								'APIPassword' => $this->payflow_password, 
								'APIVendor' => $this->payflow_vendor, 
								'APIPartner' => $this->payflow_partner
							  );
